    ...
    <HundiLogWarapper>
      ...
      <div>
        ...
        <div style={{ height: "10px" }}>
          <If condition={hundiLogQuery.isFetching}>
            <Then>
              <Skeleton
                baseColor="#ff8744"
                highlightColor="#fff"
        ...
        <div className="newsContent">
          <Row>
            <If condition={hundiLogQuery.isLoading} disableMemo>
              <Then>
                <SkeletonTheme
                  baseColor="#FFF7E8"
                  highlightColor="#fff"
              ...
              <Else>
                <If condition={hundiLogs.length != 0} disableMemo>
                  <Then>
            ...
            <If condition={hundiLogQuery?.data?.totalPages > 1}>
              <Then>
                <Col xs={12} className="mb-2 d-flex justify-content-center">
                  <ReactPaginate
                    ...
                    breakLabel="..."
                    previousLabel=""
                    pageCount={hundiLogQuery?.data?.totalPages || 0}
